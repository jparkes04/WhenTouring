...
export default function SearchBar({ handleSearch, placeholder } : { handleSearch: (query: string) => void, placeholder: string } ) {
  ...
  return (
    <form className="max-w-sm lg:max-w-3xl mx-auto" onSubmit={onSubmit}>   
        ...
        <div className="relative">
            <input type="search" id="search" name="search" className="block w-full p-4 text-lg lg:text-3xl text-zinc-800 placeholder-zinc-500 rounded-2xl bg-zinc-50 py-3.5 lg:py-5" placeholder={placeholder} required />
